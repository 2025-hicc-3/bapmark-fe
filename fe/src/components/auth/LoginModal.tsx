        ...
        <div className="flex-1 overflow-y-auto max-h-[calc(80vh-80px)]">
          {!isLoggedIn ? (
            ...
            <div className="flex flex-col items-center justify-center h-full px-6 space-y-8">
              ...
              <button
                onClick={handleLogin}
                className="w-full max-w-sm bg-white border-2 border-gray-300 rounded-lg py-4 px-6 flex items-center justify-center space-x-3 hover:bg-gray-50 transition-colors shadow-sm"
              >
